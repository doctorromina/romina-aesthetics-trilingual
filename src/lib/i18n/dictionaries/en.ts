    ...
    items: [
      {
        ...
        parkingMaps: 'https://www.google.com/maps/search/?api=1&query=Yochananof+Bat+Yam',
      },
      {
        name: 'Tel Aviv — Midtown',
        address: 'Menakhem Begin Rd 144, Tel Aviv',
        details: 'Midtown Tower, Eco House Clinic',
        mapsUrl: 'https://www.google.com/maps/search/דרך+מנחם+בגין+144+תל+אביב',
        parkingName: 'Midtown (in the building)',
        parkingWaze: 'https://waze.com/ul?ll=32.0772344,34.792922&navigate=yes',
        parkingMaps: 'https://www.google.com/maps/search/?api=1&query=Midtown+Parking+Tel+Aviv',
      },
      {
        name: 'Rishon LeZion',
        address: 'Ha-Nakhshol 30, Rishon LeZion',
        details: 'Rishonim Center',
        mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Rishonim+Center+Rishon+LeZion',
        parkingName: 'Underground in the building',
        parkingWaze: 'https://waze.com/ul?ll=31.984265,34.782318&navigate=yes',
        parkingMaps: 'https://www.google.com/maps/search/?api=1&query=Rishonim+Center+Rishon+LeZion',
      },
    ],
